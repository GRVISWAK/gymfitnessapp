...
import caloriecalcimg from '../Assets/caloriecalcimg.jpg'
...
const Dietfoods = () => {
  ...
  const renderMeal = (mealName) => {
    ...
    return (
      <div className="meal">
        <h3 style={{color:'black',marginBottom:'20px',fontSize:'25px'}}>{mealName.charAt(0).toUpperCase() + mealName.slice(1)}</h3>
        <ul>
  ...
  return (
    <div>
      ...
      <h2 class="head">Track your calories</h2>
      <div class="meals-container">
          <div class="mealbox">{renderMeal('breakfast')}</div>
          <div class="mealbox">{renderMeal('morningSnacks')}</div>
      ...
      <div className="search-filter-container">
        <SearchBar />
        <FormControl variant="outlined" class="filter-dropdown">
                  ...
                  <CardContent>
                    ...
                    <Typography variant="body2" color="text.secondary">
                      <ul>
                        ...
                        <br></br>
                        <li>
                          <button class='add' onClick={() => addToMeal('breakfast', item)}>Add to Breakfast</button>
                          <button class='add' onClick={() => addToMeal('morningSnacks', item)}>Add to Morning Snacks</button>
                          <button class='add' onClick={() => addToMeal('lunch', item)}>Add to Lunch</button>
                          <button class='add' onClick={() => addToMeal('eveningSnacks', item)}>Add to Evening Snacks</button>
                          <button class='add' onClick={() => addToMeal('dinner', item)}>Add to Dinner</button>
                        </li>
                      </ul>
                    </Typography>
                  </CardContent>
